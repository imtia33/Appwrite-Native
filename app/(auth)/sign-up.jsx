  ...
  return (
    <SafeAreaView className="flex-1 bg-background px-4">
      ...
      >
        ...
        <Label className="text-foreground mt-5 mb-2 text-lg">Name</Label>
        <Input
          placeholder="Name"
        ...
        />
        <Label className="text-foreground mt-3 mb-2 text-lg">Email</Label>
        <Input
          placeholder="Email"
          className="text-secondary-foreground border  rounded-md"
          style={{ height: 45, fontSize: 18 }}
          ...
          <View className="flex-1 mt-1">
            <Text className="text-muted-foreground " style={{ fontSize: 17 }}>
              ...
              <Text
                ...
                onPress={() => {
                  Linking.openURL("https://appwrite.io/privacy");
                }}
              >
                Privacy Policy
              </Text>{" "}
              ...
              <Text
                className="text-primary"
                onPress={() => {
                  Linking.openURL("https://appwrite.io/terms");
                }}
              >
        ...
        <View className="flex-row items-center mt-4 self-center">
          <Text
            className="text-muted-foreground text-lg justify-center"
            style={{ top: 2 }}
          >
