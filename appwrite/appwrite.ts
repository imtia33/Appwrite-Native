//This Files Initializes appwrite
...
export const getSubdomain = (region?: string) => {
  switch (region) {
    case REGION_FRA:
...
export type AppwriteRealtimeResponseEvent = (
...
function createRealtimeSubscription(
  ...
  const subscriptionPromise = realtimeInstance.subscribe(
    channelsArray,
    callback,
  );
