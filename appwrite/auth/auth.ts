...
export const logout = async () => {
  try {
    const response = await sdk.forConsole.account.deleteSession({
      sessionId: "current",
    });
    return response;
  } catch (error: any) {
...
export const deleteIdentity = async (identityId: string) => {
  try {
    const response = await sdk.forConsole.account.deleteIdentity({
      identityId,
    });
    return response;
  } catch (error: any) {
...
export const createMFAAuthenticator = async (type: AuthenticatorType) => {
  try {
    const response = await sdk.forConsole.account.createMFAAuthenticator({
      type,
    });
    return response;
  } catch (error: any) {
...
export const updateMFAAuthenticator = async (
  type: AuthenticatorType,
  otp: string,
) => {
  try {
    const response = await sdk.forConsole.account.updateMFAAuthenticator({
      type,
      otp,
    });
    return response;
...
export const deleteMFAAuthenticator = async (type: AuthenticatorType) => {
  try {
    const response = await sdk.forConsole.account.deleteMFAAuthenticator({
      type,
    });
    return response;
  } catch (error: any) {
