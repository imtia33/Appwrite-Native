...
export const SCREEN_MAP = {
  ...
  databases: {
    hasUsage: true,
    screens: [{ id: "databases", label: "Databases", icon: Database }],
  },
  functions: {
    hasUsage: true,
    screens: [
  ...
  sites: {
    hasUsage: true,
    screens: [{ id: "sites", label: "Sites", icon: Globe }],
  },
  storage: {
    hasUsage: true,
    screens: [{ id: "buckets", label: "Buckets", icon: Archive }],
  },
};

const ScreenItem = React.memo(
  ({ screen, onScreenChange, isDark, iconColor }) => {
    ...
    return (
      <Pressable
        ...
        className={cn(
          ...
          isDark ? "active:bg-slate-800/60" : "active:bg-slate-100",
        )}
      >
...
const ProjectScreenList = ({ activeCategory, onScreenChange }) => {
  const categoryData = React.useMemo(
    () => SCREEN_MAP[activeCategory] || { screens: [] },
    [activeCategory],
  );
            ...
            <View className="px-6 flex-row items-center justify-between mb-2">
              ...
              <Popover>
                ...
                <PopoverContent className="w-64">
                  ...
                  >
                    Metrics are not realtime. It may take a few hours to
                    agregrate usage data.
                  </Text>
                </PopoverContent>
              </Popover>
            </View>
