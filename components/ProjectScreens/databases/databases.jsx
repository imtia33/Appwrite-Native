...
const Databases = () => {
  ...
  const handleCreateDatabase = async (name, databaseId, enableBackups) => {
    ...
    <View className="flex-1 bg-background p-4">
      <View className="flex-row justify-between items-center mb-4">
        <View>
          ...
          <Text className="text-muted-foreground text-sm">
            Manage your project databases and collections
          </Text>
        </View>
      </View>
      ...
      {error ? (
        <View className="bg-destructive/10 p-4 rounded-lg border border-destructive/20">
          ...
          <TouchableOpacity
            onPress={() =>
              currentProject?.$id && fetchDatabases(currentProject.$id)
            }
