...
const SCOPES_CONFIG = [
  ...
  },
  {
    ...
    scopes: [
      ...
      { id: "collections.read", description: "Access to read collections" },
      {
        ...
        description: "Access to create, update, and delete collections",
      },
      { id: "attributes.read", description: "Access to read attributes" },
      {
        id: "attributes.write",
        description: "Access to create, update, and delete attributes",
      },
      { id: "indexes.read", description: "Access to read indexes" },
      {
        id: "indexes.write",
        description: "Access to create, update, and delete indexes",
      },
      { id: "documents.read", description: "Access to read documents" },
      {
        id: "documents.write",
        description: "Access to create, update, and delete documents",
      },
    ],
  },
  {
    ...
    scopes: [
      ...
      {
        id: "functions.write",
        description: "Access to create, update, and delete functions",
      },
  ...
  },
  {
    ...
    scopes: [
      ...
      {
        id: "buckets.write",
        description: "Access to create, update, and delete buckets",
      },
      { id: "files.read", description: "Access to read files" },
      {
        id: "files.write",
        description: "Access to create, update, and delete files",
      },
    ],
  },
  {
    ...
    scopes: [
      ...
      {
        id: "messages.write",
        description: "Access to create, update, and delete messages",
      },
      { id: "topics.read", description: "Access to read topics" },
      {
        id: "topics.write",
        description: "Access to create, update, and delete topics",
      },
      { id: "subscribers.read", description: "Access to read subscribers" },
      {
        id: "subscribers.write",
        description: "Access to create, update, and delete subscribers",
      },
      { id: "providers.read", description: "Access to read providers" },
      {
        id: "providers.write",
        description: "Access to create, update, and delete providers",
      },
      { id: "targets.read", description: "Access to read targets" },
      {
        id: "targets.write",
        description: "Access to create, update, and delete targets",
      },
    ],
  },
  {
    ...
    scopes: [
      ...
      {
        id: "sites.write",
        description: "Access to create, update, and delete sites",
      },
    ],
  },
  {
    ...
    scopes: [
      ...
      {
        id: "rules.write",
        description: "Access to create, update, and delete rules",
      },
    ],
  },
];
          ...
          <View className="gap-6">
            ...
            <View className="gap-4">
              ...
              <Text className="text-muted-foreground text-xs leading-relaxed">
                Choose which permission scopes to grant your application. It is
                best practice to allow only the permissions you need to meet
                your project goals.
              </Text>
              ...
              <Accordion
                type="multiple"
                className="border border-border rounded-2xl overflow-hidden mb-10"
              >
                {SCOPES_CONFIG.map((cat, idx) => {
                  const catActiveCount = cat.scopes.filter((s) =>
                    selectedScopes.has(s.id),
                  ).length;
                      ...
                      <View className="flex-row items-center px-4">
                        <Checkbox
                          ...
                          onCheckedChange={(checked) =>
                            toggleCategory(cat.scopes, checked)
                          }
                        />
